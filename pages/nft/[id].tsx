...
const NTFDropPage = ({collection}: Props) => {
    ...
    const ntfDrop = useNFTDrop(collection.address)
    ...
    useEffect(() => {
        ...
        const fetchPrice = async () => {
            const claimConditions = await ntfDrop.claimConditions.getAll()
    ...
    useEffect(() => {
        ...
        const fetchNFTDropData = async () => {
            setLoading(true)
            const claimed = await ntfDrop.getAllClaimed()
            const total = await ntfDrop.totalSupply()
            ...
            <div className="lg:col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500 ">
                <div className="flex flex-col justify-center items-center py-2 lg:min-h-screen">
                    ...
                    <div className="text-center p-5 space-y-2">
                        <h1 className="text-4xl font-bold text-white">{collection.ntfCollectionName}</h1>
            ...
            <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
                ...
                <div
                    ...
                    {loading ? (
                        ...
                        <p className="pt-2 text-xl text-green-500 ">{claimedSupply} / {totalSupply?.toString()} NFT is
                            claimed</p>
                    )}
